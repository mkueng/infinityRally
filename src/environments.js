export const worldEnvironments=[
  ...
  },
  {
    ...
    vegetation:{treeClusters:0,treesPerCluster:6,treeClusterRadius:42,crownsPerTree:6,podsPerTree:2,trunkHeightBase:1.05,trunkHeightVariance:0.4,trunkWidthBase:0.78,trunkWidthVariance:0.24,leanAmount:0.18,crownBaseScale:1.12,crownScaleStep:0.06,crownSpreadBase:1.6,crownSpreadVariance:2.6,crownLiftBase:8.8,crownLiftStep:0.36,crownWidthScale:1.18,crownFlatness:0.82,crownDepthScale:1.16,podScaleBase:0.22,podScaleVariance:0.18,podLiftBase:6.8,podLiftVariance:1.8,podElongation:1.2,grassClusters:9,grassPerCluster:80,grassClusterRadius:22,grassClusterRadiusPower:1.65,grassMinHeight:-18,grassMaxHeight:24,grassMaxSlope:0.22,grassSlopeSampleDistance:22,maxGrassInstancesPerChunk:900,cheapTreeCount:8,cheapTreeAttempts:64,cheapTreeGroupCount:1,cheapTreeGroupRadius:60,cheapTreeMinDensity:0.16,cheapTreeScaleBase:1.08,cheapTreeHeightScale:2.7,cheapTreeWidthScale:1.25,cheapTreeCrownScale:3.25,cheapTreeMinHeight:-20,cheapTreeMaxHeight:180,cheapTreeMaxSlope:0.42,cheapTreeSlopeSampleDistance:30,cheapTreePatchRadius:11,cheapTreePatchMaxHeight:190,cheapTreePatchMaxRange:13,cheapTreeRoadClearance:52,cheapTreeLean:0.08,bushClusters:0,bushesPerCluster:30,bushClusterRadius:48,bushScaleBase:1.28,bushMinHeight:-16,bushMaxHeight:22,bushMaxSlope:0.18,bushSlopeSampleDistance:24}
  },
  {
    name:"neon city",
    city:true,
